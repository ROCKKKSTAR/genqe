...
@Component({
  selector: 'app-chatbox-lounge-assistant',
  templateUrl: './chatbox-lounge-assistant.component.html',
  styleUrls: ['./chatbox-lounge-assistant.component.css']
})
export class ChatboxLoungeAssistantComponent implements OnInit {
    ...
    if (this.userMessage.trim() !== '') {
      ...
      this.WS.post(
        ...
        if (res.status === 1) {
          ...
          this.formattedResponse = res.result.answer
          // Simulate bot reply
